  ...
  return (
    <Button
      ...
      className={cn(
        ...
        isActive &&
          'bg-papayita_green text-white hover:bg-papayita_green/80 hover:text-white'
      )}
    >
  ...
  return (
    <nav className='h-20 flex border-b justify-between font-semibold   bg-white'>
      ...
      >
        <span
          className={cn(
            'text-shadow-neo scroll-m-20 text-4xl font-extrabold tracking-tight text-papayita-400 lg:text-5xl',
            font.className
          )}
        >
          papayita
